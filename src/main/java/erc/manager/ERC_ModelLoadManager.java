...
//	private static final String ExternalFileAdd = "../../../"; // �f�o�b�O���p		TODO
//	private static final String ExternalFileAdd = "../../../../"; // �p�b�P�[�W�����p
...
//			File file = new File(str+"/"+fname);
	...
	{
		String op;
		filename = removeExtention(filename);//�g���q��菜��
		while( (op = getExtention(filename)) != null )
		{
			...
			case 's'/*����*/: subOpstions(Options, op.charAt(1), op.substring(2, op.length()));		break;
			}
	...
	public static void subOpstions(ModelOptions op, char flag, String opstr)
	{
		...
		switch(flag)
		{
		case 'n' /*op:s ���Ȃ̐�*/ : op.setSeatNum(Integer.parseInt(opstr));					break;
		case 'x' /*op:s ���Ȃ̉�*/ : op.offsetX[num] = Integer.parseInt(opstr) * 0.01f;		break;
		case 'y' /*op:s ���Ȃ̍���*/: op.offsetY[num] = Float.parseFloat(opstr) * 0.01f;		break;
		case 'z' /*op:s ���Ȃ̉�*/ : op.offsetZ[num] = Float.parseFloat(opstr) * 0.01f;		break;
		case 'r' /*op:s ���Ȃ̉�]*/: op.rotZ[num] = Float.parseFloat(opstr) * 0.01f;			break;
		}	
	}
